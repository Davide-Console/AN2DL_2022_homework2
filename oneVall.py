...
def build_1vall_classifier(input_shape, classes):
    ...
    dropout = tfkl.Dropout(.5, seed=seed)(classifier)
    output_layer = tfkl.Dense(2, activation='softmax')(dropout)
...
def get_callbacks(phase_epochs):
    ...
    chkpt_dir = 'float_model/class'+str(index)
...
if __name__ == '__main__':
    ...
    batch_size = 128
    filters = 128
    model = build_NN_classifier(x_train.shape[1:], y_train.shape[-1])
    model.summary()

    learn_rates = [0.001, 0.0006, 3.6784e-04, 2.1350e-04, 1.2595e-04, 8.0690e-05, 6.0140e-05, 5.2440e-06,
                   5.0330e-06, 5.0011e-07]
