...
class model:
    def __init__(self, path):
        ...
        self.model4 = tf.keras.models.load_model(os.path.join(path, 'SubmissionModel/0.6955-0.8456-f_model.h5'))
        self.model5 = tf.keras.models.load_model(os.path.join(path, 'SubmissionModel/0.6914-0.8981-f_model.h5'))
    ...
    def predict(self, X):
        ...
        out3 = self.model3.predict(self.reshape22D(X))
        out4 = self.model4.predict(self.add_fft(X))
        out5 = self.model5.predict(X[:, :, [0, 1, 2, 3, 5]])
